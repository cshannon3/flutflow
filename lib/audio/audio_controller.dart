...
final AudioPlayerPlatform _ = AudioPlayerPlatform.instance..init();
...
///
/// The video is displayed in a Flutter app by creating a [AudioPlayer] widget.
///
...
class AudioPlayerController extends ValueNotifier<AudioPlayerValue> {
  ...
  AudioPlayerController.network(this.dataSource, {this.formatHint})
  ...
  Future<void> initialize() async {
    ...
    _textureId =
        await AudioPlayerPlatform.instance.create(dataSourceDescription);
    ...
    void eventListener(AudioEvent event) {
      ...
      switch (event.eventType) {
        case AudioEventType.initialized:
          ...
          _applyPlayPause();
          break;
        case AudioEventType.completed:
          value = value.copyWith(isPlaying: false, position: value.duration);
          _timer?.cancel();
          break;
        case AudioEventType.bufferingUpdate:
          value = value.copyWith(buffered: event.buffered);
          break;
        case AudioEventType.bufferingStart:
          value = value.copyWith(isBuffering: true);
          break;
        case AudioEventType.bufferingEnd:
          value = value.copyWith(isBuffering: false);
          break;
        case AudioEventType.unknown:
          break;
      }
    }
    ...
    _eventSubscription = AudioPlayerPlatform.instance
        .audioEventsFor(_textureId)
  ...
  Future<void> dispose() async {
    if (_creatingCompleter != null) {
      ...
      if (!_isDisposed) {
        ...
        await AudioPlayerPlatform.instance.dispose(_textureId);
      }
  ...
  Future<void> _applyLooping() async {
    ...
    await AudioPlayerPlatform.instance.setLooping(_textureId, value.isLooping);
  }
  ...
  Future<void> _applyPlayPause() async {
    ...
    if (value.isPlaying) {
      await AudioPlayerPlatform.instance.play(_textureId);
      ...
      _timer?.cancel();
      await AudioPlayerPlatform.instance.pause(_textureId);
    }
  }
  ...
  Future<void> _applyVolume() async {
    ...
    await AudioPlayerPlatform.instance.setVolume(_textureId, value.volume);
  }
  ...
  Future<Duration> get position async {
    ...
    return await AudioPlayerPlatform.instance.getPosition(_textureId);
  }
  ...
  Future<void> seekTo(Duration position) async {
    ...
    await AudioPlayerPlatform.instance.seekTo(_textureId, position);
...
class AudioPlayer extends StatefulWidget {
  ...
  /// The [AudioPlayerController] responsible for the video being rendered in
  /// this widget.
...
class _AudioPlayerState extends State<AudioPlayer> {
  ...
  Widget build(BuildContext context) {
    return //_textureId == null?
        Container();
// TODO Build audio view
       // : AudioPlayerPlatform.instance.buildView(_textureId);
  }
}
...
class VideoProgressIndicator extends StatefulWidget {
  ...
  /// The [AudioPlayerController] that actually associates a video with this
  /// widget.
  final AudioPlayerController controller;
